public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println(10 - (-1.333));
        System.out.println(10 + 1.333);
        System.out.println(11.333);
        //Expression 2
        System.out.println(23%4 + (18 - 3 / 2));
        System.out.println(23%4 + 15/2);
        ...
        System.out.println((7.07 + 2) - Math.pow(Math.sqrt(25),3));
        System.out.println(9.07 - Math.pow(Math.sqrt(25),3));
        System.out.println(9.07 - Math.pow(5,3));
        System.out.println(9.07 - 125);
